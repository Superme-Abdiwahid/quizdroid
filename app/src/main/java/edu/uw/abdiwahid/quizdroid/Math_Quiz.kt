        ...
        fun readjson() {
            ...
            try {
                ...
                for (i in 0..left.length()) {
                    left = obj.getJSONObject(2).getJSONArray("questions").getJSONObject(0)


                    var left2 = obj.getJSONObject(2).getJSONArray("questions").getJSONObject(0)
                ...
                Log.i("TERRIBLE_FAILER", e.toString())
            }
        }
